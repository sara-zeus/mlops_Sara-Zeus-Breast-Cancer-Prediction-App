...
def add_sidebar():
    # st.sidebar.image("images/body_logo.png", use_column_width=True)

    # st.sidebar.markdown(
    #     "<style>.sidebar-image-container img { border-radius: 50%; }</style>",
    #     unsafe_allow_html=True,
    # )

    # st.sidebar.image(
    #     "/Users/yasara/Desktop/o/images/heart_logo.png",
    ...
    st.sidebar.markdown(
        """
        <style> .sidebar-image-container img { border-radius: 50%; } </style>
        <img src="https://media.giphy.com/media/z1yLG7GyibZnwY3q0U/giphy.gif" alt="GIF" width="300" height="200">
        """,
        unsafe_allow_html=True,
    )

    st.sidebar.markdown(
        "<h1 style='font-weight: bold;'>Connect your device or enter the data manually:</h1>",
        unsafe_allow_html=True,
    )
    data = get_clean_data()
...
def add_predictions(input_data):
    ...
    st.image(
        "/Users/yasara/Desktop/o/images/body_logo.png",
...
def main():
    st.set_page_config(
        page_title="Sara-Zeus Breast Cancer Prediction App",
    ...
    with st.container():
        st.markdown(
            ...
            "<h1 style='font-weight: bold; color: black;'>Sara-Zeus Breast Cancer Prediction App</h1>"
            "</div>",
            unsafe_allow_html=True,
        )

    st.markdown(
        "<p style='font-weight: bold; color: black; font-size: 18px;'>Cellular Morphological Features Computed from a Digitized Image of a Fine Needle Aspirate (FNA) of a Breast Mass. This app can help laboratory technicians to predict breast cancer, to see if the patient has a malignant or benign tumor based on the obtained tissue sample. The app is based on a machine learning model that was trained on the Wisconsin Breast Cancer Dataset. </p>",
        unsafe_allow_html=True,
    )
    ...
    with col2:
        ...
        color: #FF0000; /* Change this to your desired font color */
            ...
            .st-emotion-cache-j0h0qv e1f1d6gn2{
            color: #44147C;
                padding: 0.2em 0.5em;
                border-radius: 0.5em;
